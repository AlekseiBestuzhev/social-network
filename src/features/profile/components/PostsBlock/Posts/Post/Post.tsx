...
export const Post: FC<PostType> = ({ id, text, likes, myLike, time, date, userID, name, photo }) => {
    ...
    <div className={cls.post}>
      ...
      <div className={cls.sender}>
        <div className={cls.info}>
          <p className={cls.name} data-id={userID}>
            {name}
          </p>
        ...
        <div className={cls.likes}>
          ...
          {myLike ? <RiHeart3Fill onClick={likeHandler} /> : <RiHeart3Line onClick={likeHandler} />}
        </div>
      </div>
    </div>
  );
